...
function picRoll(ele,delay){
	...
	var $btng =$(".pic-box").find(".btn-group a");
	 int= setInterval(function(){
	 	...
	 	if (current==='0px') {
	 		mleft='-640px';
	 		$(".text-box a").html("<h2>电商网站实操链接</h2>").attr("href","https://github.com/272964081/ds/index.html");
	 		$btng.removeClass('active').eq(1).addClass('active');
	 	}else if(current==='-640px'){
	 		mleft='-1280px';
	 		$(".text-box a").html("<h2>部分链接</h2>").attr("href","https://github.com/272964081/ds/product.html");
